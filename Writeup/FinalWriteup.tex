...
existing literature (REFERENCE), a $d_{x^2-y^2}$ and $d_{3z^2 -r^2}$ orbital are included. 
...
divERGe is an open-source, high-performance, C/C++/Python library that includes a truncated unity FRG (TU$^2$FRG) computational backend.
...
\begin{figure}[htbp]  % Placement: Here, Top, Bottom, Page
    \centering
    \includegraphics[width=0.9\textwidth]{convergence.png}  % Adjust width as needed
