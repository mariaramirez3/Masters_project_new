...
a range of doping \textit{(analogous to $\mu$ in the findings here)} at weak-coupling. A smooth transition between these two phases has also been observed\cite{capone2006competition}. 
