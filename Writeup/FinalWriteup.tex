...
\begin{figure}[htbp]  % Placement: Here, Top, Bottom, Page
    ...
    \caption{\textbf{Convergence testing:} Fig a) Transition temperature as a function of form factor for the nearest-neighbour 2D Hubbard model, U = 5.00, $\mu$ = 0.20eV. Fig b) Time taken to complete the calculation
