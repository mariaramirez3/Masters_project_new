...
The appearance of Magnetic stripes is another common denominator between the 1NN and 1NNN models. 
A survey of all stripes and their respective nesting vectors can be found in Tab.\ref{tab:StripesSummary}. The location of the
stripes suggest that their emergence is a consequence of strong nesting at particular chemical potential values. 
The "magic doping" stripe remains the only to have change ordering from FM to AFM as a consequence of the interplay with Superconductivity. 



\medskip 

\noindent When $\frac{t'}{t} = 0.50$, a magnetic double dome emerges, becoming more pronounced as the 
