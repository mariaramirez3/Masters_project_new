...
This section will focus on the 1NN2A model, where the orbital mixing between different orbitals is set to 0.\par
\medskip
...
emerges in the boundary of a CDW phase \textit{(See Fig.{\ref{fig:1NN2pd}})}.
...
\begin{figure}[htbp]  % Placement: Here, Top, Bottom, Page
    ...
    mixing between different orbitals. Fig a) Band structure for the undoped 1NN2A model. 
    Fig b) Band structure for the 1NN2A model at $\mu =1.0eV$  
    Fig c) Phase diagram for the undoped 1NN2A model
    Fig d) Phase diagram for the 1NN2A model at $\mu =1.00eV$}
    \label{fig:1NN2pd}
\end{figure}
...
The Superconducting regions shown in Fig.\ref{fig:1NN2pd}d. show different order parameters. The SC region at U=0.0eV is s-wave symmetric whilst the SC region at U =10.00eV
is d-wave symmetric. 
