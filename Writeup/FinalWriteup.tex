...
The 1NN model is defined as the 2D Hubbard model on a square lattice with a single orbital per site,  allowing hopping between nearest-neighbour sites \textit{(a diagrammatic representation can be found in Fig.\ref{fig:2D Hubbard model}.a)}. 
