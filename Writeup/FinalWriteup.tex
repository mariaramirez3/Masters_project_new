...
\begin{figure}[htbp]  % Placement: Here, Top, Bottom, Page
    ...
    b) Transition temperature for the superconducting region (plotted in a logarithmic scale).
...
any major changes of the superconductivity of the model. The order parameter is mostly d-wave symmetric and the $T_c$ increases
...
of a SDW instability. Whilst most key features remain the same, there are some important differences. 
...
s-wave symmetric in the vicinity of the CDW region. This behaviour is also observed in the SC regions that neighbour CDW regions for 
the $t' = 0.25, 0.50eV$ models. 
