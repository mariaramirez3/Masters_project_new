...
int main( int argc, char* argv[] ) {
    ...
    char modelname[80];
    // Format the string
    sprintf(outputname, "1NN_2orbs_%d_%d_%.2f_%.2f_out.dvg", (int)nk,(int)nkf,U,J);
    sprintf(modelname, "1NN_2orbs_%d_%d_%.2f_%.2f_mod.dvg", (int)nk,(int)nkf,U,J);
...
*/
    ...
    m->hop = diverge_read_W90_C("1NN_Mono_2orb_nomix_hr.dat",0,&m->n_hop, &m->n_orb);
